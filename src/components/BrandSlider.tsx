...
const BrandSlider = () => {
  const brands = [
    { id: 1, name: "Ministry of Daru", url: "https://www.ministryofdaru.com/", image: "/images/icons/mod.png" },
    { id: 2, name: "The Beer Garden", url: "https://www.thebeergardenindia.com/", image: "/images/icons/tbg.png" },
  ...
  const heading = [
    { text: "Discover" },
    { text: "Our" },
    { text: "Brands", className: "text-[color:--primary-color] dark:text-[color:--primary-color]" },
  ];
